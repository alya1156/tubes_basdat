...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        radial-gradient(circle at 80% 80%, rgba(212, 175, 55, 0.08) 0%, transparent 50%); z-index: 0; }
        ...
        .feature-card { text-align: center; padding: 40px 30px; border-radius: 12px; background: linear-gradient(135deg, rgba(212, 175, 55, 0.08) 0%, rgba(212, 175, 55, 0.03) 100%); margin-bottom: 30px; box-shadow: 0 2px 8px rgba(212, 175, 55, 0.1); transition: all 0.3s; border: 1px solid rgba(212, 175, 55, 0.3); position: relative; height: 280px; display: flex; flex-direction: column; justify-content: center; }
